...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dr. Sai Preethi's Skin & Aesthetic Clinic" },
      { property: "og:description", content: "Expert dermatology & aesthetic care in Hyderabad — acne, hair, pigmentation, anti-ageing, biologics & advanced lasers." },
